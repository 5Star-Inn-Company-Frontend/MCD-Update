...
import 'package:mcd/features/pos/presentation/views/pos_term_submit_doc.dart';

class PosTermAgreementScreen extends StatefulWidget {
  const PosTermAgreementScreen({super.key});

  @override
  State<PosTermAgreementScreen> createState() => _PosTermAgreementScreenState();
}

class _PosTermAgreementScreenState extends State<PosTermAgreementScreen> {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const PosTermSubmitDocScreen()));
              },
              child: Container(
                height: screenHeight(context) * 0.065,
                width: double.infinity,
