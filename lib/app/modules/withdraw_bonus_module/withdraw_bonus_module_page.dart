                  ...
                  children: [
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () => controller.setQuickAmount(controller.quickAmounts[index]),
                          child: Container(
                            decoration: BoxDecoration(
                              color: AppColors.primaryColor,
                              borderRadius: BorderRadius.circular(8),
                    ...
                    Obx(() => InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: AppColors.primaryGrey2.withOpacity(0.3)),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            controller.accountNameController.clear(); // Clear validated name on bank change
