...
class AirtimePinPayoutPage extends GetView<AirtimePinPayoutController> {
  const AirtimePinPayoutPage({super.key});
              ...
              Expanded(
                child: TextField(
                  ...
                  style: const TextStyle(
                    fontSize: 14,
                    color: AppColors.background, fontFamily: AppFonts.manRope,
                  ),
          ...
          child: Obx(() => Column(
                children: [
                  RadioListTile<String>(
                    title: Text('Wallet Balance (₦${controller.walletBalance.value}.00)', style: GoogleFonts.roboto(fontSize: 14),),
                    value: 'wallet',
                  ...
                  RadioListTile<String>(
                    title: Text('Mega Bonus (₦${controller.bonusBalance.value}.00)', style: const TextStyle(fontSize: 14),),
                    value: 'bonus',
                    groupValue: controller.selectedPaymentMethod.value,
                    onChanged: (value) => controller.selectPaymentMethod(value!),
                    controlAffinity: ListTileControlAffinity.trailing,
