        ...
        return Obx(() => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Hide/Show Detail Button
              GestureDetector(
                onTap: () {
                  controller.isCardDetailsHidden.value = !controller.isCardDetailsHidden.value;
                },
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                        controller.isCardDetailsHidden.value ? 'Show Detail' : 'Hide Detail',
                        fontSize: 14,
                        color: AppColors.primaryColor,
                      ),
                      const Gap(8),
                      Icon(
                        controller.isCardDetailsHidden.value 
              ...
              // Card Details
              _buildDetailRowModal('Name', controller.isCardDetailsHidden.value ? '****' : 'Oluwa wa'),
              const Gap(16),
              _buildDetailRowModal(
                'Card Number', 
                controller.isCardDetailsHidden.value ? '**** **** **** ****' : '2138 2138 2138 2138',
                showCopy: true,
              ),
              const Gap(16),
              _buildDetailRowModal('CVV', controller.isCardDetailsHidden.value ? '***' : '381'),
              const Gap(16),
              _buildDetailRowModal('Expiry Date', controller.isCardDetailsHidden.value ? '** ****' : 'Dec 2024'),
              const Gap(16),
              _buildDetailRowModal('Currency', 'Dollar'),
              const Gap(30),
