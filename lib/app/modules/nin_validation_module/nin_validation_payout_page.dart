...
class NinValidationPayoutPage extends GetView<NinValidationPayoutController> {
  const NinValidationPayoutPage({super.key});
  ...
  Widget _buildDetailsCard() {
    return Container(
      ...
      child: Column(
        children: [
          _rowCard('NIN Number', controller.ninNumber),
