...
class JambPaymentModulePage extends GetView<JambPaymentModuleController> {
        ...
        builder: (context) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Gap(20),
              _paymentMethodTile('wallet', 'Wallet', Icons.account_balance_wallet, context),
              _paymentMethodTile('paystack', 'Paystack', Icons.payment, context),
              _paymentMethodTile('general_market', 'General Market', Icons.store, context),
              _paymentMethodTile('mega_bonus', 'Mega Bonus', Icons.card_giftcard, context),
              const Gap(10),
            ],
          ),
        ),
    ...
    Widget _paymentMethodTile(String value, String label, IconData icon, BuildContext context) {
      return Obx(() {
