...
class PosAuthorizeWithdrawalModulePage extends GetView<PosAuthorizeWithdrawalModuleController> {
  const PosAuthorizeWithdrawalModulePage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const Gap(60),
            Obx(() => InkWell(
              onTap: controller.pin.length == 4 ? () => _successfulWithdrawalDialog(context) : null,
              child: Container(
                height: screenHeight(context) * 0.065,
                width: double.infinity,
                decoration: BoxDecoration(
                  color: controller.pin.length == 4 ? const Color.fromRGBO(90, 187, 123, 1) : const Color.fromRGBO(90, 187, 123, 0.3),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Center(child: Text('Confirm Pin', style: GoogleFonts.manrope(fontSize: 16.sp, fontWeight: FontWeight.w500, color: Colors.white),)),
              ),
            ))
          ]
        )
      ...
      children: List.generate(4, (index) {
        return Container(
          ...
          child: SizedBox(
            ...
            child: CircleAvatar(
              backgroundColor: index < controller.pin.length ? const Color.fromRGBO(112, 112, 112, 1) : Colors.white,
            ),
          ),
        );
      }),
  ...
  Widget _buildKeypadButton(String label) {
    return GestureDetector(
      onTap: () => controller.onPinPressed(label),
      child: Container(
  ...
  void _successfulWithdrawalDialog(BuildContext context) {
    showGeneralDialog(
      context: context, 
