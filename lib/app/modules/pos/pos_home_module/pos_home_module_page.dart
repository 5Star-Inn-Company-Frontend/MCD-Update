...
class PosHomeModulePage extends GetView<PosHomeModuleController> {
  const PosHomeModulePage({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        onTap: controller.navigateToRequestNewTerminal,
                        child: ClipRRect(
                      ...
                      InkWell(
                        onTap: controller.navigateToTerminalRequests,
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(4), 
                          child: SizedBox(
                            height: screenHeight(context) * 0.09,
