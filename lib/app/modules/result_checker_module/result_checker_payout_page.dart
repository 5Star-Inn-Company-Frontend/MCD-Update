...
class ResultCheckerPayoutPage extends GetView<ResultCheckerPayoutController> {
  const ResultCheckerPayoutPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            const Gap(30),
            // Exam logo/image
            if (controller.examLogo.isNotEmpty)
              Image.asset(
                controller.examLogo,
                height: 80,
                width: 80,
  ...
  Widget _buildDetailsCard() {
    return Container(
      ...
      child: Column(
        children: [
          _rowCard('Exam Type', controller.examName),
