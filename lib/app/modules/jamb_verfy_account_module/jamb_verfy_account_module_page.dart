...
class JambVerfyAccountModulePage extends GetView<JambVerfyAccountModuleController> {
    
    const JambVerfyAccountModulePage({Key? key}) : super(key: key);
                      ...
                      TextFormField(
                        ...
                        decoration: textInputDecoration.copyWith(
                          ...
                          suffixIcon: IconButton(
                            icon: const Icon(Icons.paste, color: AppColors.primaryGrey2),
